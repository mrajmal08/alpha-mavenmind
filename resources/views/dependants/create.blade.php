                ...
                <div class="user">
                    <div class="container">
                        <div class="user-header">
                            <h4 class="user-role py-3">Add Dependant</h4>
                            <a href="{{ route('dependants.index') }}" class="close-btn">x</a>
                        </div>
                        <div class="search-user">
                            <div class="form-container">
                                <form method="POST" action="{{ route('dependants.insert') }}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-row mt-3">
                                        <div class="form-group">
                                            ...
                                            <div class="radio-btn">
                                                <input type="radio" id="travel_outside_yes" name="travel_outside" value="yes">
                                                <label class="label" for="yes">Yes</label>
                                                <input type="radio" id="travel_outside_no" name="travel_outside" value="no">
                                    ...
                                    <div class="form-row">
                                        <textarea class="form-control" name="travel_history" id="travel_history" rows="3"></textarea>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <textarea class="form-control" name="officer_note" id="officer_note" rows="3"></textarea>
                                    </div>
